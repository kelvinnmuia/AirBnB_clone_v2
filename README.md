...
```
  ...
  * [models/user.py](https://github.com/kelvinnmuia/AirBnB_clone_v2/blob/master/models/user.py)
...
```
  ...
  * [models/review.py](https://github.com/kelvinnmuia/AirBnB_clone_v2/blob/master/models/review.py)
  * [models/user.py](https://github.com/kelvinnmuia/AirBnB_clone_v2/blob/master/models/user.py)
  * [models/place.py](https://github.com/kelvinnmuia/AirBnB_clone_v2/blob/master/models/place.py)
